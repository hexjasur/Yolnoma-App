...
export default function ImageCompressorTool() {
  ...
  const compress = async () => {
    ...
    try {
      const results = await invoke<CompressionResult[]>('convert_images_batch', { conversions: files.map((file) => ({ input_path: file.path, output_dir: outputDir || undefined, output_format: 'webp', quality })) });
  ...
  return <ToolCard>
    <ToolTitle icon={Minimize2} text="Image Compressor" subtitle="Reduce image file sizes by converting images to optimized WebP locally." />
