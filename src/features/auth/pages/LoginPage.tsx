...
export default function LoginPage() {
  ...
  const currentEnv = BACKEND_ENVIRONMENTS.find(
    (e) => e.url === selectedBackend,
  );
      ...
      <div className="relative w-full max-w-md">
        ...
        >
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 hover:border hover:border-white/[0.08] mb-6 shadow-inner relative overflow-hidden group">
              ...
              {/* <Drama
                ...
                strokeWidth={1.75}
              /> */}
              <img src={images.brands.logo_png} alt="Yolnoma Logo" />
            </div>
            ...
            <div className="pt-2">
              ...
              {showManualCode && (
                <form
                  ...
                  className="mt-3 space-y-2.5 animate-in fade-in duration-200"
                >
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="truncate">
                    Server: {currentEnv?.name || selectedBackend}
                  </span>
                </div>
