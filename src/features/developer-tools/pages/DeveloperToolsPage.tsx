...
import { ArrowLeftRight, Binary, Braces, Code2, FileText, Globe2, Hash, LockKeyhole, QrCode, ShieldCheck, Terminal, Regex, WandSparkles } from 'lucide-react';
...
type Tab = 'json-formatter' | 'jwt-decoder' | 'uuid-generator' | 'markdown-studio' | 'qr-generator' | 'base64' | 'curl-converter' | 'regex-visualizer' | 'lorem-ipsum' | 'ip-lookup' | 'bcrypt' | 'diff-checker' | 'readme-generator';
...
const tabs: TabDefinition[] = [
  ...
  ['readme-generator', 'AI Tools', WandSparkles],
];
