    ...
    <div style={{ position: 'relative' }}>
      ...
      <div style={{ display: 'flex', gap: 8, marginBottom: 10 }}>
        ...
        <button
          ...
          title={value ? "Boshqa rasm yuklash (ImgBB)" : "Fayl yuklash (ImgBB)"}
        >
          {isUploading ? (
          ...
          <span>{value ? 'Almashtirish' : 'Yuklash'}</span>
        </button>
      ...
      {isUploading && (
        ...
        >
          ...
          <p style={{ fontSize: 13, color: 'var(--text-primary)', margin: 0 }}>
            {upload.phase === 'reading' ? 'Fayl o\'qilmoqda…' : `ImgBB ga yuklanmoqda — ${upload.progress}%`}
          </p>
      ...
      {!value && !isUploading && (
        ...
        >
          ...
          <p style={{ fontSize: 13, color: 'var(--text-muted)', margin: 0 }}>
            Fayl tashlang yoki <span style={{ color: 'var(--accent)', fontWeight: 600 }}>tanlang</span>
          </p>
