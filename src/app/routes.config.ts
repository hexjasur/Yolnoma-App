...
const SettingsPage = lazyPage(
  () => import("@/features/account/pages/SettingsPage"),
);
const BackgroundRemoverPage = lazyPage(
  () => import("@/features/background-remover/pages/BackgroundRemoverPage"),
);
const MarketplacePage = lazyPage(
  () => import("@/features/marketplace/pages/MarketplacePage"),
);
const CurrencyConverterPage = lazyPage(
  () => import("@/features/currency/pages/CurrencyConverterPage"),
);
const PerformanceDetailPage = lazyPage(
  () => import("@/features/performance/pages/PerformanceDetailPage"),
);
const AvPerformanceDetailPage = lazyPage(
  () => import("@/features/performance/pages/AvPerformanceDetailPage"),
);
...
const VideoDetailPage = lazyPage(
  () => import("@/features/videos/pages/VideoDetailPage"),
);
const VideosPage = lazyPage(() => import("@/features/videos/pages/VideosPage"));
const CleanerPage = lazyPage(
...
const SteamReviewPage = lazyPage(
  () => import("@/features/steam/review/SteamReviewPage"),
);
const CrosshairPage = lazyPage(
  () => import("@/features/crosshair/pages/CrosshairPage"),
);
...
export const ROUTE_CONFIG: readonly RouteDefinition[] = [
  ...
  },
  {
    ...
    guard: roleGuard(
      "performances",
      "Access restricted: Performances section is available to Owner only.",
    ),
    label: "Performance",
    icon: Gamepad,
    navGroup: "workspace",
  ...
  {
    id: "av-performance-detail",
    path: "/performances/av/:id",
    component: AvPerformanceDetailPage,
    guard: roleGuard(
      "performances",
      "Access restricted: Performances section is available to Owner only.",
    ),
  ...
  },
  {
    ...
    guard: roleGuard(
      "videos",
      "Access restricted: Stream section is available to Owner only.",
    ),
    label: "Stream",
    icon: Download,
    navGroup: "workspace",
  ...
  },
  {
    ...
    description: "160+ currencies & charts",
    icon: Coins,
    navGroup: "tools",
    pinnable: true,
  },
  ...
  },
  {
    ...
    component: SteamIdlerPage,
    label: "Steam / Idler",
    description: "Automated idling",
    icon: Gamepad2,
    navGroup: "steam",
    pinnable: true,
  },
  {
    ...
    component: ImagePage,
    label: "Image",
    description: "Convert, compress & optimize images",
    icon: ImageIcon,
    navGroup: "tools",
    pinnable: true,
  },
  {
    ...
    label: "YT Video Downloader",
    description: "Download videos locally",
    icon: Download,
    navGroup: "tools",
    pinnable: true,
  },
  ...
  },
  {
    ...
    description: "Browse compressed files",
    icon: Archive,
    navGroup: "tools",
    pinnable: true,
  },
  ...
  },
  {
    ...
    label: "Cleaner",
    description: "Clean unwanted files",
    icon: BrushCleaning,
    navGroup: "tools",
    pinnable: true,
  },
  {
    ...
    description: "Custom desktop crosshair",
    icon: Crosshair,
    navGroup: "tools",
    pinnable: true,
  },
  ...
  },
  {
    ...
    label: "Steam / SAM",
    description: "Manage Steam achievements",
    icon: Gamepad,
    navGroup: "steam",
    pinnable: true,
  },
  {
    ...
    component: SteamReviewPage,
    label: "Steam / Review",
    description: "Review Steam games",
    icon: Gamepad2,
    navGroup: "steam",
    pinnable: true,
  },
  {
    ...
    description: "JSON, JWT, Markdown & more",
    icon: Wrench,
    navGroup: "workspace",
    pinnable: true,
  },
  {
    ...
    mobile: true,
    label: "AI Tools",
    description: "AI-powered project workspaces",
    icon: WandSparkles,
    navGroup: "workspace",
    pinnable: true,
  },
  {
    ...
    description: "Edit JSON and transform it into cards",
    icon: Wrench,
    navGroup: "tools",
    pinnable: true,
  },
  ...
  },
  {
    ...
    label: "Yolnoma World",
    description: "Explore the living 3D desktop",
    icon: Trees,
    navGroup: "tools",
    pinnable: true,
  },
...
export const getRouteById = (id: string) =>
  ROUTE_CONFIG.find((route) => route.id === id);
export const getRouteStatus = (id: string): RouteStatus =>
  getRouteById(id)?.status ?? "stable";
const visibleOnCurrentPlatform = (route: RouteDefinition) =>
  !isAndroidApp() || route.mobile === true;
