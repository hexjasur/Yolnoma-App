...
export default function RouteLoadingFallback({
  ...
  return (
    <div
      className={`flex items-center justify-center rounded-3xl border border-[#F2EDE6]/10 bg-gradient-to-b from-[#14110E] to-[#0B0908] px-6 py-16 ${preview ? "fixed inset-0 z-[110] h-screen w-screen rounded-none bg-black/80 backdrop-blur-sm" : "h-full min-h-[calc(100vh-6rem)] w-full"}`}
      role="status"
      aria-live="polite"
    >
